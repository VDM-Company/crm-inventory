...
<template>
  <UDashboardPanel id="delivery-orders-detail">
    <template #body>
      <div
        v-if="status === 'pending'"
      ...
      >
        <nav class="flex items-center gap-1.5 text-sm">
          ...
          <UIcon name="i-lucide-chevron-right" class="size-3.5 text-dimmed" />
          <span class="font-medium text-primary">Detail Delivery</span>
        </nav>
        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div class="flex items-start gap-3">
            ...
            <div class="space-y-1">
              ...
              <p class="text-base text-muted">
                See detail delivery information here
              </p>
            </div>
          </div>
          ...
          <div class="flex flex-wrap items-center gap-3">
            ...
            <UButton
              ...
              color="neutral"
              variant="outline"
              :to="`/operations/delivery-orders/${id}/edit`"
            />
          </div>
        </div>
