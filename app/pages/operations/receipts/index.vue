...
const { data, status } = await useFetch<ReceiptListItem[]>('/api/receipts', {
  lazy: true,
  default: () => []
})
</script>
    ...
    <template #body>
      <div class="flex flex-col gap-6">
        <nav class="flex items-center gap-1.5 text-sm">
          ...
          <span class="font-medium text-primary">Receipts</span>
        </nav>
